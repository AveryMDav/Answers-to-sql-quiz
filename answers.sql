...
SELECT DISTINCT c.id FROM customers c JOIN orders o ON c.id = o.customer_id WHERE c.email = 'pclark74@gmail.com';
...
SELECT o.id, o.status, o.order_total FROM orders o JOIN customers c ON o.customer_id = c.id WHERE c.id = 100;
